...
public  class VotingPageRohit extends DoFn<KV<String,Iterable<String>>,KV<String,RankedPageRohit>> implements Serializable{
    String voterName;
    int contributorVotes;
    double pageRank;
    public VotingPageRohit(String voterName,Integer contributorVotes2, double pageRank){
        this.voterName = voterName;
        this.contributorVotes = contributorVotes2;      
        this.pageRank = pageRank;  
    }

    public VotingPageRohit(String voterName,Integer contributorVotes2){
        this.voterName = voterName;
        this.contributorVotes = contributorVotes2;      
        this.pageRank = 1.0;  
    }
