...
public  class VotingPageShaik extends DoFn<KV<String,Iterable<String>>,KV<String,RankedPageShaik>> implements Serializable{
    String voterName;
    int contributorVotes;
    double pageRank = 1.0;
    public VotingPageShaik(String voterName,Integer contributorVotes2, double pageRank){
        this.voterName = voterName;
        this.contributorVotes = contributorVotes2;      
        this.pageRank = pageRank;  
    }

    public VotingPageShaik(String voterName,Integer contributorVotes2){
        this.voterName = voterName;
        this.contributorVotes = contributorVotes2;      
